...
<html>
<head>
	<title>Looche Product Offerings Brochure</title>
	<!-- Meta -->
...
<div id="flipbook-container-1" class="flipbook-container">
	...
	<div id="flipbook-1" class="flipbook">
		...
		<div class="fb-page double">
			<div class="page-content">
				<div class="container">
					<img src="pages/1.jpg" class="bg-img"/>
					<img src="pages/1-zoomed.jpg" class="bg-img zoom-large"/>
				</div>
			</div>
		</div>
		...
		<div class="fb-page double">
			<div class="page-content">
				<div class="container">
					<img src="pages/2.jpg" class="bg-img"/>
					<img src="pages/2-zoomed.jpg" class="bg-img zoom-large"/>
				</div>
			</div>
		</div>
		...
		<div class="fb-page double">
			<div class="page-content">
				<div class="container">
					<img src="pages/3.jpg" class="bg-img"/>
					<img src="pages/3-zoomed.jpg" class="bg-img zoom-large"/>
				</div>
			</div>
		</div>
